<div class="offcanvas offcanvas-start" tabindex="-1" id="mySideBar" style="max-width: 80%;">
    ...
    <div class="offcanvas-body">
      <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
        <li class="nav-item"><a class="nav-link active" href="/tarefas">Lista de Tarefas</a></li>
        <li class="nav-item"><a class="nav-link active" href="/aleatorio">Gerador de Senhas</a></li>
